  ...
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col">
          <h3 class="page-title">Leave (HR)</h3>
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Leave (HR) </li>
          </ul>
        </div>
      </div>
    </div>
              ...
              <?php if (!empty($row)): ?>
                <?php foreach ($row as $key => $value): ?>
                  <tr>
                    ...
                    <td><?php echo $value["dept_division"] ?> <br> <span><?php echo $value["dept_position"] ?></span> </td>
                    ...
                    <td class="text-right">
                      <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="<?php echo base_url()."hr/Hr_attendance_leave/updateLeaveFlag/approve/".$value["leave_id"] ?>"><i class="fa fa-check m-r-5 text-success"></i> Approve </a>
                          <a class="dropdown-item" href="<?php echo base_url()."hr/Hr_attendance_leave/updateLeaveFlag/decline/".$value["leave_id"] ?>"><i class="fa fa-close m-r-5 text-danger"></i> Decline </a>
                        </div>
                      </div>
                    </td>
                  </tr>
