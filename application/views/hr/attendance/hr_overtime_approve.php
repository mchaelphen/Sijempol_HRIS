      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title mb-0">Approve Form </h4>
          </div>

          <div class="card-body">
            <form action="<?php echo base_url()."hr/Hr_attendance_overtime/UpdateOTFlag/approve" ?>" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" value="<?php echo !empty($overtime_approved_hour)?$overtime_approved_hour:"" ?>" name="overtime_approved_hour" min="0" max="6" required/>
                  </div>
                </div>
              </div>
